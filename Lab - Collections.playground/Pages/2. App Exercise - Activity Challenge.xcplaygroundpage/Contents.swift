 ...
 */
var walkingChallenges: [String] = ["Walk 3 blocks", "Walk to the nearest grocery store", "Walk a mile"]
var runningChallenges: [String] = ["Run for 5 minutes straight", "Run for 10 minutes straight", "Run for 15 minutes straight"]
/*:
...
if userChallenges .isEmpty {
    ...
    print("You have committed to \(userChallenges[0])")
} else {
